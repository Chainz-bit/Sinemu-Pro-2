...
class MatchingController extends Controller
{
    public function store(Request $request): RedirectResponse
    {
        ...
        if (($result['ok'] ?? false) !== true) {
            return back()->with('error', (string) ($result['message'] ?? 'Pencocokan gagal diproses.'));
        }
        ...
        return back()->with('status', 'Pencocokan berhasil ditandai dan notifikasi telah dikirim.');
    }
    ...
    public function dismiss(Request $request): RedirectResponse
    {
        ...
        if (($result['ok'] ?? false) !== true) {
            return back()->with('error', (string) ($result['message'] ?? 'Penandaan kandidat tidak cocok gagal diproses.'));
        }

        return back()->with('status', 'Kandidat ditandai tidak cocok dan tidak akan ditampilkan lagi.');
    }
}
