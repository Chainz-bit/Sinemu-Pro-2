...
class ClaimController extends Controller
{
    public function store(Request $request): RedirectResponse
    {
        ...
        if (Schema::hasColumn('laporan_barang_hilangs', 'status_laporan')
            ...
            return back()->with('error', 'Laporan barang hilang harus disetujui admin terlebih dahulu sebelum klaim.');
        }
        ...
        if (!$pencocokan) {
            return back()->with('error', 'Barang ini belum ditandai cocok oleh admin dengan laporan Anda.');
        }
        ...
        return redirect()
            ->route('user.claim-history')
            ->with('status', 'Pengajuan klaim berhasil dikirim. Pantau status verifikasi di Riwayat Klaim.');
    }
}
