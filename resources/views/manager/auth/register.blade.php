    ...
    <main class="register-shell register-body">
        ...
        <section class="login-right" aria-label="Form registrasi {{ $managerRoleLabelLower }}">
            <div class="right-content">
                ...
                <form method="POST" action="{{ manager_route('register') }}" class="login-form" novalidate>
                    @csrf
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="nama" type="text" name="nama" value="{{ old('nama') }}" placeholder="Nama lengkap {{ $managerRoleLabelLower }}" required autocomplete="name">
                        </div>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="{{ config('roles.admin.default_email') }}" required autocomplete="email">
                        </div>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="username" type="text" name="username" value="{{ old('username') }}" placeholder="Username {{ $managerRoleLabelLower }}" required autocomplete="username">
                        </div>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="instansi" type="text" name="instansi" value="{{ old('instansi') }}" placeholder="Nama instansi {{ $managerRoleLabelLower }}" required autocomplete="organization">
                        </div>
                    </div>
                    ...
                    <button class="btn-submit" type="submit">Daftar {{ $managerRoleLabel }}</button>
                </form>
