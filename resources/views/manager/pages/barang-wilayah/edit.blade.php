...
@php
    ...
    $pageTitle = 'Edit Barang Wilayah - ' . $managerRoleLabel;
    $activeMenu = 'found-items';
    $topbarBackUrl = manager_route('barang-wilayah.index');
    ...
    <div class="container-fluid py-3 py-md-4">
        <div class="card border-0 shadow-sm mx-auto" style="max-width: 760px;">
            <div class="card-header bg-white">
                ...
                <p class="text-secondary small mb-0">Barang ini hanya bisa diedit oleh {{ $managerRoleLabelLower }} dengan wilayah yang sama.</p>
            </div>
            <form method="POST" action="{{ manager_route('barang-wilayah.update', $barang) }}" class="card-body">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ manager_route('barang-wilayah.index') }}" class="btn btn-light">Batal</a>
