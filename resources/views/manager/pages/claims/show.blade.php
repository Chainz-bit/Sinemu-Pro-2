...
<section class="claim-detail-layout">
        ...
        @if(($statusKey ?? 'menunggu') === 'menunggu')
            <div class="claim-detail-bottom-actions claim-detail-bottom-actions-stack">
                <form method="POST" action="{{ manager_route('claim-verifications.approve', $klaim->id) }}" class="claim-verification-form" data-confirm-delete data-claim-verification-form>
                    @csrf
