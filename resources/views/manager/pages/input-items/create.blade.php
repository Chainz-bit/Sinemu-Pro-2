...
@php
    ...
    $searchAction = manager_route('input-items');
...
<section class="input-card">
            <form method="POST" action="{{ manager_route('input-items.store') }}" enctype="multipart/form-data" class="input-form">
                @csrf
                ...
                <div class="form-group form-col-6 pickup-field">
                    ...
                    <input id="penanggung_jawab_pengambilan" type="text" name="penanggung_jawab_pengambilan" class="form-input" value="{{ old('penanggung_jawab_pengambilan', $manager?->nama) }}" placeholder="Nama {{ $managerRoleLabelLower }}/petugas penanggung jawab">
                </div>
