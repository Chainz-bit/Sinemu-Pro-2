        ...
        <form method="POST" action="{{ route('super.login.store') }}" class="super-login-form">
            ...
            <div class="super-login-field">
                ...
                <div class="super-input-wrap">
                    ...
                    <input id="login" name="login" type="text" value="{{ old('login') }}" required placeholder="contoh: superadmin@sinemu.com atau superadmin" autocomplete="username">
                </div>
            ...
            <div class="super-login-field">
                ...
                <div class="super-input-wrap">
                    ...
                    <input id="password" name="password" type="password" required placeholder="Masukkan kata sandi" autocomplete="current-password">
            ...
            <button type="submit" class="super-login-submit">Masuk ke Dashboard</button>
        </form>
